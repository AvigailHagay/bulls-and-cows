...
/**
 * This servlet handles requests to the /api/highscores endpoint.
 * It reads the high scores from a file and sends them to the client in JSON format.
 * It also handles POST requests to the same endpoint, which are used to add new high scores.
 */
...
public class ApiServlet extends HttpServlet {
    ...
    /**
     * This class is used to send the high scores to the client in JSON format.
     */
    @Override
